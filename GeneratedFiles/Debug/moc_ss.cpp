...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ss_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ss_t qt_meta_stringdata_ss = {
    {
QT_MOC_LITERAL(0, 0, 2), // "ss"
QT_MOC_LITERAL(1, 3, 4), // "test"
...
void ss::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ss::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ss::test)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ss::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ss.data,
      qt_meta_data_ss,  qt_static_metacall, nullptr, nullptr}
};
