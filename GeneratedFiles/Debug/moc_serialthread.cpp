...
QT_MOC_LITERAL(1, 13, 10), // "catchError"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "QString&"
QT_MOC_LITERAL(4, 34, 13), // "serialContent"
QT_MOC_LITERAL(5, 48, 11) // "readContent"

    },
    "SerialThread\0catchError\0\0QString&\0"
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialThread::catchError)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialThread::*_t)(QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialThread::serialContent)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialThread::catchError(QString & _t1)
{
...
// SIGNAL 1
void SerialThread::serialContent(QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
